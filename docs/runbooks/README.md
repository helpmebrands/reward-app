...
| Cloud Run services | `reward-app` (the static site, the PWA until #174), `reward-api` (the service tier) |
...
| URLs | site <https://staging.helpmereward.com> (also <https://reward-app-bduraqeztq-uc.a.run.app>); api <https://reward-api-bduraqeztq-uc.a.run.app> |
...
GitHub (develop)
  ...
  │
  ├─ CD (cd.yml, apps/site): build image ──► Artifact Registry ──► reward-app revision ──► smoke test
  │
