...
- [[api-architecture]] — The handler, the entrypoint, the migrations, the container and the workspace wiring.
- [[api-tests]] — What the api suites guard: the health route and the migration runner.
