...
- [[mobile-tests]] — What the Flutter suites guard: the theme, the store, the Today, Credits, Cards, Value, Add a card and editor screens, the Field pattern, the credit sheet, the swipe row and the undo snackbar.
